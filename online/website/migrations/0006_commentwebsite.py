    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateField(auto_now=True, verbose_name='Comment publication date')),
                ('rating', models.IntegerField(verbose_name='Rating comment')),
                ('update_date', models.DateField(auto_now=True, verbose_name='Comment update date')),
